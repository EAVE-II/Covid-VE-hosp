---
title: "Covid-19 Vaccine Effects Case Control EAVE - Hospitalisation following a positive Covid test"
...
results <- readRDS(paste0(project_path,"/output/temp/CR_cc_summary_hosp_covid.RDS")) 
...
Cases are all individuals with a hospitalisation for covid, within 14 days of a positive test, or covid on the SMR01 record for admission.  10 controls were selected at random, matched on age and gender, from all individuals who had not had severe covid up to the date of the severe outcome in the case. 
